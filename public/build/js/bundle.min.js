function darkMode(){document.querySelector(".dark-mode-btn").addEventListener("click",(function(){document.body.classList.toggle("dark-mode")}))}function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",responsiveNav)}function responsiveNav(){const e=document.querySelector(".navigation");e.classList.contains("show")?e.classList.remove("show"):e.classList.add("show")}
